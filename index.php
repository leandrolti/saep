            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Seleção de Alunos da EP</h3>
                ...
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <div class="text-center">
                      <button type="submit" name="loginSaep" class="btn bg-gradient-info w-100 mt-4 mb-0">Acessar sistema de seleção</button>
                    </div>
                  </form>
                </div>
              ...
              $senha = $_POST['senha']; // Não use hash aqui, apenas receba a senha

              // Alterar a consulta para buscar apenas o email
              $select = "SELECT * FROM tb_saep_usuario WHERE BINARY email=:email";
              ...
              try {
                  ...
                  $usuario = $result->fetch(PDO::FETCH_OBJ); // Pegue os dados do usuário

                  if ($contar > 0 && password_verify($senha, $usuario->senha)): // Verifique a senha aqui

                      // Autenticar usuário
                      $_SESSION['loginuser'] = $login;
                      $_SESSION['senhauser'] = $usuario->senha;
                      ...
                      if ($_SESSION['nivel'] == 1) {
                          ...
                          header("Refresh: 3, pages/home.php?esc=cadAluno");
                      } else {
                          echo '<div class="alert alert-success">
                                    <strong>Você será redirecionado(a) para o painel!</strong> Aguarde »»»
                                </div>';
                      ...
                      echo '<div class="alert alert-warning">Usuário ou senha incorretos</div>';
